...
## Appendix Figure A.7a (International) -----------------------------------------
...
## Appendix Figure A.7c (Electricity) -----------------------------------------
...
# save plot
png(filename= file.path(dir[["figures"]], "Appendix_Figure_A7a.png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(plot_3a1)
dev.off()

# save plot
png(filename= file.path(dir[["figures"]], "Appendix_Figure_A7b.png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(plot_3a2)
dev.off()

# save plot
png(filename= file.path(dir[["figures"]], "Appendix_Figure_A7c.png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(plot_3a3)
dev.off()

# save plot
png(filename= file.path(dir[["figures"]], "Appendix_Figure_A7d.png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(plot_3a4)
dev.off()
...
png(filename= file.path(dir[["figures"]], "Appendix_Figure_A8.png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(plot_4)
dev.off()
...
png(filename= file.path(dir[["figures"]], "Appendix_Figure_9a.png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(plot_5a)
dev.off()
...
# save plot
png(filename= file.path(dir[["figures"]], "Appendix_Figures_A_9b .png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(combine)
dev.off()
