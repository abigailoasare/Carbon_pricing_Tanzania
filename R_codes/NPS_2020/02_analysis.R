...
ggplot(oa1,
  ...
  ggtitle("outlier_uppers per Item over Income Group", "Tanzania") +
...
ggplot(bdn_cor_check,
  ...
  theme_bw() + 
  scale_fill_nejm() +
  labs(fill = "Quintile before\n outlier_lower/upper Correction") +
  scale_y_continuous(
    labels = function(x)
      format(
        x,
  ...
  xlab("Quintile after outlier_lower/upper Correction") + ylab("Population")
...
# To include other commet and uncomment codes
