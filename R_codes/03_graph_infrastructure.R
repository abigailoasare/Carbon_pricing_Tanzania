...
# Combine plots
legend_a <- cowplot::get_legend(plot_ck_b)
...
# save plot
png(filename= file.path(dir[["figures"]], "Figure_B1c.png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(combine)
dev.off()
...
# Combine plots
legend_a <- cowplot::get_legend(plot_lg_a)
...
# save plot
png(filename= file.path(dir[["figures"]], "Figure_B1a.png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(combine)
dev.off()
...
# save plot
png(filename= file.path(dir[["figures"]], "Figure_B1b.png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(combine)
dev.off()
...
# save plot
png(filename= file.path(dir[["figures"]], "Figure_B1d.png"), 
    width = 15.5, height = 15, unit = "cm", res = 400)
print(combine)
dev.off()
