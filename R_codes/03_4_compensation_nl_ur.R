...
func_0_tg_q123 <- function(Incidence.X) {
...
tza221_tg_q123 <- func_0_tg_q123(tza_final)$Full_df
tza222_tg_q123 <-func_0_tg_q123(tza_final)$Summarised_df
...
func_0_cmt <- function(Incidence.X) {
...
tza221_cmt <- func_0_cmt(tza_final)$Full_df
tza222_cmt <-func_0_cmt(tza_final)$Summarised_df
...
write.xlsx(all_com_test, 
           file.path(dir[["analysis"]], "hh_budget_change_nl_IGUR_q123.xlsx")
)
...
all_com_2_3_r <-all_com_2_3 %>% 
  filter(Urban=="Rural")

all_com_2_3_u <-all_com_2_3 %>% 
  filter(Urban=="Urban")
...
plot_r <- ggplot(all_com_2_3_r ) +
  ...
  #ggtitle("Rural--Different Compensation schemes") +
  theme(
  ...
  geom_magnify(from = c(0.5, 5.5, -0.05, 0.10), 
               to = c(2, 5.5, 0.40, 1.3), 
               shadow = TRUE,
               linetype='dashed',
               colour = "darkblue",
...
plot_u <- ggplot(all_com_2_3_u ) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "red") +
  #ggtitle("Urban--Different Compensation schemes") +
  theme(
    axis.text.y = element_text(size = 12),
    axis.text.x = element_text(size = 12),
    axis.title  = element_text(size = 12),
