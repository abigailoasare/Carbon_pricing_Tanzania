...
tg_qui_12_g_hh<-tt_exp_CO2_all/no_hh_qui_12
tg_qui_12_n_hh <- tt_exp_CO2_within_all/no_hh_qui_12

tg_qui_12_g_pc<-tt_exp_CO2_all/no_pop_qui_12
tg_qui_12_n_pc <- tt_exp_CO2_within_all/no_pop_qui_12


# Global
qui_12$tg_adults_g_hh<-ifelse(qui_12$incg_5==1|
                                qui_12$incg_5==2&
                                qui_12$adults>0,(0.6*tt_exp_CO2_all)/no_hh_qui_12,
                              0)
unique(qui_12$tg_adults_g_hh)

qui_12$tg_child_g_hh<-ifelse(qui_12$incg_5==1|qui_12$incg_5==2&qui_12$children>0,(0.4*tt_exp_CO2_all)/no_hh_qui_12,0)
...
# Global
qui_12$tg_adults_n_hh<-ifelse(qui_12$incg_5==1|qui_12$incg_5==2&qui_12$adults>0,(0.6*tt_exp_CO2_within_all)/no_hh_qui_12,0)
unique(qui_12$tg_adults_n_hh)

qui_12$tg_child_n_hh<-ifelse(qui_12$incg_5==1|qui_12$incg_5==2&qui_12$children>0,(0.4*tt_exp_CO2_within_all)/no_hh_qui_12,0)
...
# Global
qui_12$tg_adults_g_pc<-ifelse(qui_12$incg_5==1|qui_12$incg_5==2&qui_12$adults>0,(0.6*tt_exp_CO2_all)/no_pop_qui_12,0)
unique(qui_12$tg_adults_g_pc)

qui_12$tg_child_g_pc<-ifelse(qui_12$incg_5==1|qui_12$incg_5==2&qui_12$children>0,(0.4*tt_exp_CO2_all)/no_pop_qui_12,0)
...
# Global
qui_12$tg_adults_n_pc<-ifelse(qui_12$incg_5==1|qui_12$incg_5==2&qui_12$adults>0,(0.6*tt_exp_CO2_within_all)/no_pop_qui_12,0)
unique(qui_12$tg_adults_n_pc)

qui_12$tg_child_n_pc<-ifelse(qui_12$incg_5==1|qui_12$incg_5==2&qui_12$children>0,(0.4*tt_exp_CO2_within_all)/no_pop_qui_12,0)
...
write.xlsx(all_com_test, 
           file.path(dir[["analysis"]], "hh_budget_change_gl_IG.xlsx")
)
...
write.xlsx(NLT_test, 
           file.path(dir[["analysis"]], "hh_budget_change_gl_IG_NLT.xlsx")
)
...
ESST_2 <- ESST |>
  ...
  mutate(
    Label=ifelse(comp_type=="GCP","Without Compensation",NA),
    Label=ifelse(comp_type=="EST","Solar Light",Label),
    Label=ifelse(comp_type=="SCT","Solar Cooker",Label)
  )
...
write.xlsx(ESST_test, 
           file.path(dir[["analysis"]], "hh_budget_change_gl_IG_ESST.xlsx")
)




# Global Compensation Plots  ---------------------------------------------------
